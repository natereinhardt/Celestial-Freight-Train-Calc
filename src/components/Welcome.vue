  ...
  <div class="container welcome-container bg-gray-800 bg-opacity-10">
    ...
    <div class="content">
      ...
      <p>
        ...
        Select your outbound (station we are picking up from) and your inbound (station we are shipping to) from the available stations. Copy and paste the items you want delivered into the "Package Details" text area below. Click "Run Quote" to get a delivery quote. From there, you can look at the mocked contract creation screens to streamline the in-game process.
      </p>
      <br>
      ...
      <ol class="bullets">
        <li>Please limit your packages to a maximum of 60,000 m³ to ensure compatibility with our distribution system (DST). Failure to comply may result in contract delays. If breaking up the contract, price each package according to the website. Consider relocating items to Otitoh IV - Moon 1 - Lai Dai Corp. Factory to avoid this temporary policy during our service ramp-up. Apologies for any inconvenience.</li>
      </ol>
      </p>
    </div>
  </div>
